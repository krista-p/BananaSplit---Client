    ...
    <div className="w-screen md:w-screen h-auto top-40 md:top-24 bottom-24 fixed border-secondary border-8 bg-primary shadow-lg rounded-lg overflow-y-scroll">
      <div className="flex flex-row m-2">
        <div className="flex flex-col w-3/4">
          <h1 className="text-xl md:text-3xl m-4">and the winning banana is... <span className="text-2xl md:text-5xl bg-secondary px-2 text-primary rounded-full">username</span></h1>
