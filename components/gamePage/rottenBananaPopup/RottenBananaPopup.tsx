...
const RottenBananaPopup = ({ rottenBanana }) => (
  <div className="w-screen h-screen top-0 left-0 fixed border-secondary border-8 bg-primary shadow-lg overflow-y-auto scroll-bar-dark">
    <div className="flex flex-col my-4 h-full">
      <div className="flex flex-row justify-between h-24">
        <h1 className="text-xl md:text-4xl ml-12 mt-6">
          <span className="text-2xl md:text-5xl bg-secondary px-2 text-primary rounded-full">{rottenBanana}</span>
          ...is a rotten banana!!
        </h1>
        <Link href="/">
          <button
